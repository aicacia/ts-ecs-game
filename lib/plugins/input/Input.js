...
var Input = /** @class */ (function (_super) {
    ...
    Input.createForBrowser = function (element) {
        return new Input().addEventListener(new WebEventListener_1.WebEventListener(element));
    };
    ...
    Input.prototype.onUpdate = function () {
        ...
        this.eventListeners.forEach(function (eventListener) {
            for (var i = 0, il = _this.events.length; i < il; i++) {
