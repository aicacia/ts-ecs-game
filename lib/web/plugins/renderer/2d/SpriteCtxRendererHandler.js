...
var SpriteCtxRendererHandler = /** @class */ (function (_super) {
    tslib_1.__extends(SpriteCtxRendererHandler, _super);
    function SpriteCtxRendererHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SpriteCtxRendererHandler.prototype.onRender = function () {
        var _this = this;
        this.getManager(Sprite_1.SpriteManager).ifSome(function (spriteManager) {
            var renderer = _this.getRequiredRenderer();
            spriteManager.getComponents().forEach(function (sprite) {
                var image = sprite
                    .getImageAsset()
                    .flatMap(function (webImageAsset) { return webImageAsset.getImage(); });
    ...
    return SpriteCtxRendererHandler;
