...
var Scene = /** @class */ (function (_super) {
    ...
    Scene.prototype.findWithName = function (name) {
        return this.find(function (entity) { return entity.getName() === name; }, true);
    };
    ...
    Scene.prototype.findAllWithName = function (name) {
        return this.findAll(function (entity) { return entity.getName() === name; }, true);
    };
    ...
    Scene.prototype._addEntityNow = function (entity, isChild) {
        ...
        entity.forEachChild(function (child) { return _this._addEntityNow(child, true); }, false);
    ...
    Scene.prototype._removeEntityNow = function (entity) {
        var _this = this;
        var entitySceneOption = entity.getScene();
        if (entitySceneOption.isSome()) {
            var entityScene = entitySceneOption.unwrap();
        ...
        if (entity.isRoot()) {
            ...
            entity.getParent().ifSome(function (parent) { return parent.removeChild(entity); });
        }
        entity
            .getChildren()
            .slice()
    ...
    Scene.prototype.toJSON = function () {
        return {
            name: this.name,
            entities: this.entities.map(function (entity) { return entity.toJSON(); }),
            plugins: this.plugins.map(function (plugin) { return plugin.toJSON(); }),
        };
    };
    Scene.prototype.fromJSON = function (json) {
        ...
        if (json_1.isJSONArray(json.plugins)) {
            this.addPlugins(json.plugins.map(function (plugin) { return Plugin_1.Plugin.newFromJSON(plugin); }));
        }
        this.maintain();
        return this;
    };
