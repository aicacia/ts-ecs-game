...
var Sprite = /** @class */ (function (_super) {
    ...
    function Sprite(imageAsset) {
        ...
        _this.onImageLoadHandler = function () {
            _this.getImage().ifSome(function (img) {
                _this.clipWidth = img.width;
                _this.clipHeight = img.height;
            });
    ...
    Sprite.prototype.setLayer = function (layer) {
        ...
        managerOption.map(function (manager) { return manager.removeComponent(_this); });
        this.layer = layer | 0;
        managerOption.map(function (manager) { return manager.addComponent(_this); });
        return this;
    };
