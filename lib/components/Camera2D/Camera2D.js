...
var Camera2D = /** @class */ (function (_super) {
    ...
    Camera2D.prototype.isActive = function () {
        var _this = this;
    ...
    Camera2D.prototype.toJSON = function () {
        return tslib_1.__assign(tslib_1.__assign({}, _super.prototype.toJSON.call(this)), { width: this.width, height: this.height, size: this.size, background: this.background });
    };
