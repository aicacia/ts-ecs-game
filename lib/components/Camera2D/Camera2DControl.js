...
var Component_1 = require("@aicacia/ecs/lib/Component");
...
var VEC2_0 = gl_matrix_1.vec2.create(), VEC2_1 = gl_matrix_1.vec2.create(), VEC2_2 = gl_matrix_1.vec2.create(), ZERO = gl_matrix_1.vec2.fromValues(0, 0), MIN_SCALE = gl_matrix_1.vec2.fromValues(math_1.EPSILON, math_1.EPSILON);
