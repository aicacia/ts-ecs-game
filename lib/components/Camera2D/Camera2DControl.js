...
var Camera2DControl = /** @class */ (function (_super) {
    ...
    Camera2DControl.prototype.onUpdate = function () {
        ...
        var mouseWheel = input.getValue("mouse-wheel"), zoomSpeed = gl_matrix_1.vec2.set(VEC2_2, this.zoomSpeed, this.zoomSpeed);
        if (mouseWheel > 0) {
