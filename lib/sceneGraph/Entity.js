...
var Entity = /** @class */ (function (_super) {
    ...
    Entity.prototype.UNSAFE_setScene = function (scene) {
    ...
    Entity.prototype.validateRequirements = function () {
        ...
        try {
            for (var _b = tslib_1.__values(this.components), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                utils_1.filterRequirements(missingComponents, component.getRequiredComponents(), function (C) { return !_this.hasComponent(C); });
                utils_1.filterRequirements(missingPlugins, component.getRequiredPlugins(), function (P) { return !_this.getRequiredScene().hasPlugin(P); });
            }
        }
        ...
        if (missingComponents.length > 0 || missingPlugins.length > 0) {
            var componentMessage = missingComponents.map(function (missingRequirement) {
                return _this + " requires " + IRequirement_1.requirementToString(missingRequirement) + " Component";
            });
            var pluginMessage = missingPlugins.map(function (missingRequirement) {
                return _this + " requires " + IRequirement_1.requirementToString(missingRequirement) + " Plugin";
            });
